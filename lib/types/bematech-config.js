module.exports = {
  ...
  // Text format
  TXT_NORMAL      : Buffer.from([0x1b, 0x57, 0x00]), // Normal text
  TXT_2HEIGHT     : Buffer.from([0x1b, 0x57, 0x10]), // Double height text
  TXT_2WIDTH      : Buffer.from([0x1b, 0x57, 0x20]), // Double width text
  TXT_4SQUARE     : Buffer.from([0x1b, 0x57, 0x30]), // Quad area text
